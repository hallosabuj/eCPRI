...
func ParseECPRIMessage(messageBuffer []byte) Message {
	...
	} else if messageBuffer[1] == byte(4) {
		fmt.Println("received message type is 4")
		msg.MessageType = 4
		msg.Type_4 = ParseMessageTye_4(messageBuffer)
	} else if messageBuffer[1] == byte(5) {
	...
	} else if messageBuffer[1] == byte(7) {
		fmt.Println("received message type is 7")
		msg.MessageType = 7
		msg.Type_7 = ParseMessageTye_7(messageBuffer)
	} else {
